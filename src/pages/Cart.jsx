...
const Cart = () => {
  ...
  const payment = async (token) => {
    await axios.post("https://backend-shopquanao.onrender.com/pay", {
      amount: totalAmt * 100,
      token: token,
    });
  };
        ...
        <div className="w-1/3 bg-[#fafafa] py-6 px-4">
          ...
          {payNow && (
              <div className="w-full mt-6 flex items-center justify-center">
                <StripeCheckout
                  stripeKey="pk_test_51NlZDCBtLpIWughZir6cLVysd5UslPlsOkULyu1X2ODbjfZ97UHiZIoFr1NPXOvu0MFbrHvETxOLtHaRMTRIKwXm00KpBHUu2o"
